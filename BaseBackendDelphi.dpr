...
uses
  ...
  Web.WebBroker,
  Datasnap.DSSession,
  smUsuarios in 'smUsuarios.pas' {Usuarios: TDSServerModule},
  scServer in 'scServer.pas' {Server: TDataModule},
  wmRouter in 'wmRouter.pas' {Router: TWebModule},
  ServerContantes in 'ServerContantes.pas';
